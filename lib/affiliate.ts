...
export const amazonProducts: AmazonProduct[] = [
  ...
  },
  {
    ...
    category: "Console",
    pitch: "La console de référence pour jouer à GTA 6 dès le 19 novembre 2026.",
  ...
  },
  {
    ...
    category: "Manette",
    pitch: "Gâchettes adaptatives et retour haptique : la conduite GTA 6 prend vie.",
  ...
  },
  {
    ...
    name: "DualSense édition limitée",
    category: "Manette",
    pitch: "Un coloris exclusif pour accompagner votre partie de GTA 6.",
    query: "manette DualSense PS5 édition limitée coloris",
  },
  {
    id: "pulse-elite",
